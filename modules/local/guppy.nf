process GUPPY {
    ...
    def proc_options = params.guppy_gpu ? "--device $params.gpu_device --gpu_runners_per_device $params.gpu_runners_per_device --chunks_per_runner $params.gpu_chunks_per_runner --chunk_size $params.gpu_chunk_size" : "--num_callers 2 --cpu_threads_per_caller ${task.cpus/2}"
